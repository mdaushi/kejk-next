              ...
              {response ? (
                <div className="mb-8 flex flex-col items-start justify-start italic text-zinc-600 dark:text-zinc-300">
                  <div className="flex items-center justify-start space-x-2">
                    ...
                    <p className="bg-gradient-to-tr from-purple-600 to-cyan-600 bg-clip-text pt-2 font-mono text-sm text-transparent dark:from-purple-400 dark:to-cyan-400">
                      Generated by <a href="https://apps.apple.com/gb/app/arti/id1659936985" target="_blank" rel="noreferrer" className="underline font-bold decoration-cyan-500 decoration-2 underline-offset-4">Arti</a>
                    </p>
                  </div>
                  {output}
