            ...
            <div>
              {response ? (
                <div className="mb-4 flex flex-col items-start justify-start italic text-neutral-600 dark:text-neutral-300">
                  <div className="mb-2 flex h-10 w-10 items-center justify-center  rounded-full bg-gradient-to-tr from-blue-400 to-teal-400 dark:from-blue-500 dark:to-teal-600">
                    <SparklesIcon
                      width={24}
                      height={24}
