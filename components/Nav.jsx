...
const Nav = () => {
  ...
  return (
    <div className={`${sans.variable}`}>
      ...
      <div
        as="nav"
        className="fixed bottom-4 left-0 right-0 z-10 mx-auto flex h-max w-max items-center justify-center rounded-full border border-neutral-200 bg-neutral-100 p-1 shadow-lg duration-500 dark:border-neutral-800 dark:bg-neutral-950 dark:shadow-none md:hidden"
      >
