        ...
        {router.isFallback ? (
          ...
          <>
            ...
            >
              ...
              >
                View summary
                {response ? (<ChevronUpIcon width={16} height={16} className="ml-2" />) : (<ChevronDownIcon width={16} height={16} className="ml-2" />)}
              </Button>
            </div>
            <div>
              {response ? (
                <div className="mb-8 flex flex-col items-start justify-start italic text-neutral-600 dark:text-neutral-300">
                  <div className="flex items-center justify-start space-x-2">
                    ...
                    <p className="bg-gradient-to-tr from-blue-600 to-teal-600 bg-clip-text pt-2 text-sm font-mono text-transparent dark:from-blue-300 dark:to-teal-300">
                      Generated by Davinci-003
                    </p>
                  </div>
                  {output}
