...
const Nav = () => {
  ...
  return (
    <div className={`${sans.variable}`}>
      ...
      <div
        as="nav"
        className="fixed bottom-4 left-0 right-0 z-10 mx-auto flex h-max w-max items-center justify-center rounded-full border border-zinc-200 bg-white/20 backdrop-blur-lg p-1 shadow-lg duration-500 dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-none md:hidden"
      >
